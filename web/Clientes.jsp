                        ...
                        <c:forEach var="cliente" items="${clientes}">
                            <tr class="tabla-fondo-personalizado">
                                ...
                                <td class="text-center">
                                    <button type="button" class="btn btn-success editarUsuario" data-Id="${cliente.idPersona}}">Editar</button>


                                    <button type="button" class="btn btn-sm btn-danger eliminarUsuario" data-id="${cliente.idPersona}">Eliminar</button>
